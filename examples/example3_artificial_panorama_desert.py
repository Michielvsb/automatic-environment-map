...
stream1 = imagemap.create_stream(position=(200,0), func=homographynet, data=sequence, memory=2, distance=100, borders=False, indicate_centers=True, last_border=True) # homography func
