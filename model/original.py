...
class HomographyNet(nn.Module):
    ...
    def __init__(self):
        ...
        self.batchnorm9 = nn.BatchNorm1d(32768)
        self.batchnorm10 = nn.BatchNorm1d(1024)

        self.conv1_64 = nn.Conv2d(2,64,3,padding=(1,1))

        self.conv2_64 = nn.Conv2d(64, 64, 3,padding=(1,1))
        self.max_pooling1 = nn.MaxPool2d((2,2), stride=2)

        self.conv3_64 = nn.Conv2d(64,64,3,padding=(1,1))

        self.conv4_64 = nn.Conv2d(64,64,3,padding=(1,1))
        self.max_pooling2 = nn.MaxPool2d((2,2), stride=2)

        self.conv5_128 = nn.Conv2d(64,128,3,padding=(1,1))

        self.conv6_128 = nn.Conv2d(128,128,3,padding=(1,1))
        self.max_pooling3 = nn.MaxPool2d((2,2), stride=2)

        self.conv7_128 = nn.Conv2d(128,128,3,padding=(1,1))

        self.conv8_128 = nn.Conv2d(128,128,3,padding=(1,1))

        self.lin1 = nn.Linear(16*16*128,1024)
